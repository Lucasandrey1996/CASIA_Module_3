...
# MAGIC %sql
# MAGIC DROP DATABASE IF EXISTS lua_lakehouse.bronze CASCADE;
# MAGIC DROP DATABASE IF EXISTS lua_lakehouse.silver CASCADE; 
# MAGIC DROP DATABASE IF EXISTS lua_lakehouse.gold CASCADE;
...
# MAGIC %sql
# MAGIC USE CATALOG lua_lakehouse;
# MAGIC
# MAGIC CREATE DATABASE IF NOT EXISTS lua_lakehouse.bronze;
# MAGIC CREATE DATABASE IF NOT EXISTS lua_lakehouse.silver;
# MAGIC CREATE DATABASE IF NOT EXISTS lua_lakehouse.gold;
# MAGIC
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE gold.dim_product_category (
# MAGIC   -- Incremental surrogate key
# MAGIC   _tf_dim_product_category_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY NOT NULL,
# MAGIC
# MAGIC   -- Attributes
# MAGIC   prod_cat_category_id INT,
# MAGIC   prod_cat_name STRING,
# MAGIC   prod_cat_parent_category_id INT,
# MAGIC   prod_cat_level_1_id INT,
# MAGIC   prod_cat_level_1_name STRING,
# MAGIC   prod_cat_level_2_id INT,
# MAGIC   prod_cat_level_2_name STRING,
# MAGIC
# MAGIC   -- Technical columns
# MAGIC   _tf_create_date TIMESTAMP,
# MAGIC   _tf_update_date TIMESTAMP
...
# MAGIC   _tf_dim_product_category_id,
# MAGIC   prod_cat_category_id,
# MAGIC   prod_cat_name,
# MAGIC   prod_cat_parent_category_id,
# MAGIC   prod_cat_level_1_id,
# MAGIC   prod_cat_level_1_name,
# MAGIC   prod_cat_level_2_id,
# MAGIC   prod_cat_level_2_name,
# MAGIC   _tf_create_date,
# MAGIC   _tf_update_date
# MAGIC )
# MAGIC VALUES (
...
# MAGIC   prod_weight DECIMAL(19, 4),
# MAGIC   _tf_dim_product_category_id BIGINT
# MAGIC   REFERENCES gold.dim_product_category(_tf_dim_product_category_id),
# MAGIC   prod_product_model_id INT,
# MAGIC   prod_product_model_name STRING,
# MAGIC   prod_product_model_catalog_description STRING,
# MAGIC
# MAGIC   -- Technical columns
# MAGIC   _tf_create_date TIMESTAMP,
# MAGIC   _tf_update_date TIMESTAMP
...
# MAGIC   prod_weight,
# MAGIC   _tf_dim_product_category_id,
# MAGIC   prod_product_model_id,
# MAGIC   prod_product_model_name,
# MAGIC   prod_product_model_catalog_description,
# MAGIC   _tf_create_date,
# MAGIC   _tf_update_date
# MAGIC )
# MAGIC VALUES (
